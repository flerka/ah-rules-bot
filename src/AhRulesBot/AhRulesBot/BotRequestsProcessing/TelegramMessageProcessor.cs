    ...
    internal class TelegramMessageProcessor : ITelegramMessageProcessor
    {
        ...
        public async Task Process(Message msg, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                await SendBatchMessagesToChat(msg.Chat.Id, result.Data, cancellationToken, result.Ttl);
            }
            catch (Exception e)
            {
                _logger.Error(
        ...
        private async Task SendBatchMessagesToChat(long chatId, List<string> msgs, CancellationToken cancellationToken, TimeSpan? ttl = null)
        {
